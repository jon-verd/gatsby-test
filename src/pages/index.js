...
const IndexPage = () => {
  return (
    <>
      ...
      <h1> {'Vicios >:)'} </h1> 
      <h2> 
       <br/> This site serves two purposes: 
       <br/> 1. For me to practice my skills as a developer and experiment in web development.
       <br/> 2. To build the foundation of the Vicios website.
      </h2>
      <h3>
        What is Vicios?
      </h3>
